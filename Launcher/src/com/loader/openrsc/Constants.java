...
{
    public static final String SERVER_IP = "wolfkingdom.net";
    public static final int SERVER_PORT = 43594;
    public static final String frameTitle = "Open RSC";
    public static final String base_url = "http://wolfkingdom.net/";
    
    public static final String HOME_URL = "http://wolfkingdom.net/";
    public static final String FORUM_URL = "http://wolfkingdom.net/forum.php";
    public static final String SHOP_URL = "http://wolfkingdom.net/shop.php";
