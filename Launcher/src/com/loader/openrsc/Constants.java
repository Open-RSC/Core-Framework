...
{
    public static final String SERVER_DOMAIN = "dev1.openrsc.com";
    public static final int SERVER_PORT = 43594;
    public static final String GAME_NAME = "Open RSC";
    public static final String base_url = "https://dev.openrsc.com/";
    public static final String rss_url = "https://openrsc.com/blog/rss";
