...
class Browser extends Region {
    ...
    public Browser() {
        ...
        for (int i = 0; i < captions.length; i++) {
            ...
            final boolean addButton = (hpl.getText().equals("Play " + GAME_NAME + " Now") && (hpl.getText().equals("Play " + Dev_GAME_NAME + " Now")));
