...
public final class World {
	...
	public World(Scene var1, GraphicsController var2) {
		try {
			...
			try {
				tileArchive = new ZipFile(new File(Config.F_CACHE_DIR + File.separator + "Landscape.rscd"));
			} catch (Exception e) {
				e.printStackTrace();
				System.exit(1);
			}
	...
	public void loadWorldmapSection(int sector, int height, int sectionX, int sectionY) {
		Sector s = null;
		try {
