...
<div class="panel panel-default">
	...
	<div class="embended-info">
		<p><i class="fa fa-info-circle" aria-hidden="true"></i> Use the Open RSC database to find information on quests, skills, play guides and more.</p>
	</div>
	...
	<div class="col-sm-6">
		<div class="game_play">
			...
			<a href="?m=game_guide" class="guide_click">
				...
				<p>The game play guide includes information on a number of important topics such as installing the game, controls, and navigation of the user interface.
