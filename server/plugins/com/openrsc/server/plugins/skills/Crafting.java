...
public class Crafting implements InvUseOnItemListener,
	...
	public void onInvUseOnObject(GameObject obj, final Item item, Player owner) {
		switch (obj.getID()) {
								...
								public void handleReply(int option, String reply) {
									...
									owner.setMenuHandler(new MenuOptionListener(options) {
										public void handleReply(final int option, final String reply) {
											owner.setBatchEvent(new BatchEvent(owner, 1200, "Craft Jewelry", Formulae.getRepeatTimes(owner, Skills.CRAFTING), false) {
												public void action() {
						...
						public void action() {
							...
							owner.setMenuHandler(new MenuOptionListener(options) {
								public void handleReply(final int option, String reply) {
									...
									owner.setBatchEvent(new BatchEvent(owner, 1200, "Craft Silver", Formulae.getRepeatTimes(owner, Skills.CRAFTING), false) {
										@Override
										public void action() {
			...
			case 179: // Potters Wheel & Soft Clay
				...
				owner.setMenuHandler(new MenuOptionListener(options) {
					public void handleReply(int option, String reply) {
						...
						owner.setBatchEvent(new BatchEvent(owner, 600, "Craft Clay", Formulae.getRepeatTimes(owner, Skills.CRAFTING), false) {
							@Override
							public void action() {
			...
			case 178: // Potters Oven & Unfired Clay
				...
				owner.setBatchEvent(new BatchEvent(owner, 1800, "Craft Clay", Formulae.getRepeatTimes(owner, Skills.CRAFTING), false) {
					@Override
					public void action() {
						if (Constants.GameServer.WANT_FATIGUE) {
							if (owner.getFatigue() >= owner.MAX_FATIGUE) {
	...
	private boolean doCutGem(Player player, final Item chisel, final Item gem) {
		...
		player.setBatchEvent(new BatchEvent(player, 600, "Cut Gem", Formulae.getRepeatTimes(player, Skills.CRAFTING), false) {
			@Override
			public void action() {
