			...
			if (!player.getCache().hasKey("gnome_cooking")) {
				...
				switch (stage) {
					case 1:
						...
						mes(player, config().GAME_TICK * 2, "aluft gives you one tomato, some cheese...");
					...
					case 2:
						...
						if (player.getCarriedItems().hasCatalogID(ItemId.CHEESE_AND_TOMATO_BATTA.id(), Optional.of(false))) {
							...
							mes(player, config().GAME_TICK * 3, "you give aluft the gnome batta");
							...
							mes(player, config().GAME_TICK * 2, "aluft gives you four bars of chocolate");
							give(player, ItemId.CHOCOLATE_BAR.id(), 4);
							mes(player, config().GAME_TICK * 2, "some equa leaves, some chocolate dust...");
							give(player, ItemId.EQUA_LEAVES.id(), 1);
					...
					case 3:
						...
						if (player.getCarriedItems().hasCatalogID(ItemId.CHOCOLATE_BOMB.id(), Optional.of(false))) {
							...
							mes(player, config().GAME_TICK * 2, "you give aluft the choc bomb");
							player.message("he takes a bite");
							...
							mes(player, config().GAME_TICK * 3, "mr gianne gives you some dough, some equaleaves...");
					...
					case 4:
						...
						if (player.getCarriedItems().hasCatalogID(ItemId.TOAD_BATTA.id(), Optional.of(false))) {
							...
							mes(player, config().GAME_TICK * 3, "you give mr gianne the toad batta");
					...
					case 5:
						...
						if (player.getCarriedItems().hasCatalogID(ItemId.WORM_HOLE.id(), Optional.of(false))) {
							...
							mes(player, config().GAME_TICK * 3, "you give mr gianne the worm hole");
					...
					case 6:
						...
						if (player.getCarriedItems().hasCatalogID(ItemId.TOAD_CRUNCHIES.id(), Optional.of(false))) {
							...
							mes(player, config().GAME_TICK * 3, "you give mr gianne the toad crunchie");
	...
	private void myCurrentJob(Player player, Npc n) {
		...
		if (job == 0) {
			...
			if (ifheld(player, ItemId.WORM_BATTA.id(), 2)
				...
				mes(player, config().GAME_TICK * 3, "you give aluft two worm batta's a veg batta and a toad batta");
			...
			if (player.getCarriedItems().hasCatalogID(ItemId.CHOCOLATE_BOMB.id(), Optional.of(false))
				...
				mes(player, config().GAME_TICK * 3, "you give aluft choc bomb, two choc crunchies and two toad crunchies");
				player.getCarriedItems().remove(new Item(ItemId.CHOCOLATE_BOMB.id()));
			...
			if (ifheld(player, ItemId.CHOC_CRUNCHIES.id(), 2)) {
				say(player, n, "all done, here you go");
				mes(player, config().GAME_TICK * 3, "you give aluft the two choc crunchies");
				player.getCarriedItems().remove(new Item(ItemId.CHOC_CRUNCHIES.id(), 2));
			...
			if (player.getCarriedItems().hasCatalogID(ItemId.CHOCOLATE_BOMB.id(), Optional.of(false))
					&& ifheld(player, ItemId.CHOC_CRUNCHIES.id(), 2)) {
				say(player, n, "here you go aluft");
				mes(player, config().GAME_TICK * 3, "you give aluft one choc bomb and two choc crunchies");
				player.getCarriedItems().remove(new Item(ItemId.CHOCOLATE_BOMB.id()));
				player.getCarriedItems().remove(new Item(ItemId.CHOC_CRUNCHIES.id(), 2));
				player.incExp(Skills.COOKING, 425, true);
				npcsay(player, n, "they look great, well done",
			...
			if (ifheld(player, ItemId.VEG_BATTA.id(), 2)
				...
				say(player, n, "here you go aluft");
				mes(player, config().GAME_TICK * 3, "you give aluft two veg batta's and a worm hole");
			...
			if (player.getCarriedItems().hasCatalogID(ItemId.VEGBALL.id(), Optional.of(false))
					...
					&& player.getCarriedItems().hasCatalogID(ItemId.WORM_HOLE.id(), Optional.of(false))) {
				say(player, n, "all done, here you go");
				mes(player, config().GAME_TICK * 3, "you give aluft one veg ball, one twisted toads legs and one worm hole");
			...
			if (player.getCarriedItems().hasCatalogID(ItemId.CHEESE_AND_TOMATO_BATTA.id(), Optional.of(false))
				...
				mes(player, config().GAME_TICK * 3, "you give one cheese and tomato batta,one veg ball...",
			...
			if (ifheld(player, ItemId.SPICE_CRUNCHIES.id(), 2)
					...
					&& player.getCarriedItems().hasCatalogID(ItemId.VEGBALL.id(), Optional.of(false))) {
				say(player, n, "all done, here you go");
				mes(player, config().GAME_TICK * 3, "you give aluft the tangled toads legs and two worm crunchies");
