				...
				for (int fishGiven = 0; fishGiven < fishCaught; fishGiven++) {
					...
					if (isFishRoll) {
						if (catchFish(81, player.getSkills().getLevel(Skills.FISHING))) {
							mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..a manta ray!");
							...
							mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..a sea turtle!");
							...
							mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..a shark!");
							...
							mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..a sword fish");
							...
							mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..a lobster");
							...
							mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..some tuna");
							...
							mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..some anchovies");
							...
							mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..a sardine");
							give(player, ItemId.RAW_SARDINE.id(), 1);
							player.incExp(Skills.FISHING, 80, false);
						} else {
							mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..some shrimp");
						...
						if (randomJunkItem == ItemId.EDIBLE_SEAWEED.id()) { // Edible seaweed
							mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..some seaweed");
							...
							mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..an oyster!");
							...
							if (randomJunkItem == ItemId.BROKEN_GLASS_DIGSITE_LVL_2.id() || randomJunkItem == ItemId.BUTTONS.id()
								...
								mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..some " + player.getWorld().getServer().getEntityHandler().getItemDef(randomJunkItem).getName());
							}
							// Old boot
							else if (randomJunkItem == ItemId.OLD_BOOT.id()) {
								mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..an " + player.getWorld().getServer().getEntityHandler().getItemDef(randomJunkItem).getName());
							}
							// broken arrow, broken staff, Rusty sword, vase
							else {
								mes(player, player.getWorld().getServer().getConfig().GAME_TICK * 2, "..a " + player.getWorld().getServer().getEntityHandler().getItemDef(randomJunkItem).getName());
							}
