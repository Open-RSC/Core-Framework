			...
			case 0:
				...
				if (choice == 0) {
					...
					if (choice2 == 0) {
						...
						say(p, n, "No, hitting rocks is for the boring people, sorry");
						npcsay(p, n, "That is your choice, nice to meet you anyway");
					}
					...
					say(p, n, "Do you have any to sell?");
					npcsay(p, n, "Not at the moment, sorry. Try again later");
				}
				break;
			case 1:
				npcsay(p, n, "Have you got my materials yet traveller?");
				if (p.getCarriedItems().getInventory().countId(ItemId.CLAY.id()) >= 6
					...
					say(p, n, "I have everything you need");
					...
					npcsay(p, n, "Please use my anvils any time you want");
					p.sendQuestComplete(Quests.DORICS_QUEST);
					p.updateQuestStage(getQuestId(), -1);

				} else {
					say(p, n, "Sorry, I don't have them all yet");
					npcsay(p, n, "Not to worry, stick at it",
						"Remember I need 6 Clay, 4 Copper ore and 2 Iron ore");
				}
				break;
			case -1:
				npcsay(p, n, "Hello traveller, how is your Metalworking coming along?");
				say(p, n, "Not too bad thanks Doric");
				npcsay(p, n, "Good, the love of metal is a thing close to my heart");
				break;
		}
	}
