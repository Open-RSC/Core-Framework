...
public class Civillians implements TalkNpcTrigger {
	...
	public void onTalkNpc(Player player, Npc n) {
		...
		boolean hasAnyCat = hasCat || hasKitten || hasKardiasCat || hasGertrudesCat
				|| (hasFluffsKittens && player.getWorld().getServer().getConfig().WANT_SHOW_KITTENS_CIVILLIAN);
		...
		case CIVILLIAN_APRON:
			...
			if (!hasAnyCat) {
				...
				else if (hasFluffsKittens && player.getWorld().getServer().getConfig().WANT_SHOW_KITTENS_CIVILLIAN)
