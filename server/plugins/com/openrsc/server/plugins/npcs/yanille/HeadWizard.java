...
public class HeadWizard implements TalkToNpcExecutiveListener, TalkToNpcListener {
	...
	public void onTalkToNpc(Player p, Npc n) {
		if (Server.getServer().getConfig().WANT_MISSING_GUILD_GREETINGS && n.getID() == NpcId.HEAD_WIZARD.id()) {
	...
	public boolean blockTalkToNpc(Player p, Npc n) {
		return Server.getServer().getConfig().WANT_MISSING_GUILD_GREETINGS && n.getID() == NpcId.HEAD_WIZARD.id();
	}
