 ...
 */
 ...
 -- not necessary but placeholder in case expansion + compat
...
(
  ...
  -- structure mainly, initial value comes from selected class
...
(
    ...
    `influence`   tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
    `praygood`    tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
    `prayevil`    tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
    `goodmagic`   tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
    `evilmagic`   tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
    `cooking`     tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
    `tailoring`   tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
    `woodcutting` tinyint(3) UNSIGNED NOT NULL DEFAULT 1,
...
(
  ...
  -- not visible in retro client but was tracked
...
(
    ...
    `influence`   int(10) UNSIGNED,
    `praygood`    int(10) UNSIGNED,
    `prayevil`    int(10) UNSIGNED,
    `goodmagic`   int(10) UNSIGNED,
    `evilmagic`   int(10) UNSIGNED,
    `cooking`     int(10) UNSIGNED,
    `tailoring`   int(10) UNSIGNED,
    `woodcutting` int(10) UNSIGNED,
...
(
  ...
  -- not a thing from client, may be from website later?
...
(
  ...
  -- notes: kept similar structure for website
  -- fields that would come as cache: is_attackable, pk_changes_left, hide_online_status
...
(
    ...
    `fatigue`           int(10)                      DEFAULT 0, -- not used
    ...
    `quest_points`      int(5)                       DEFAULT NULL, -- not a thing but kept if people log in with modern client
    `bank_size`         int(10) UNSIGNED NOT NULL    DEFAULT 48, -- not used but became 48
