...
/*		try
		{
			String reply = "220 mail.rscemulation.net ESMTP Postfix (Debian/GNU)";
			...
			if(Runtime.getRuntime().exec("/scripts/proxycheck -dmail.rscemulation.net:25 -c chat::\" + reply + \" -s " + ip.getHostName()).waitFor() != 0)
			{
