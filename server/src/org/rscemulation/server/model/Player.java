...
import org.rscemulation.server.core.Watcher;
...
import org.rscemulation.server.packetbuilder.MiscPacketBuilder;
import org.rscemulation.server.packetbuilder.RSCPacketBuilder;
import org.rscemulation.server.packethandler.DMHandler;
import org.rscemulation.server.states.Action;
import org.rscemulation.server.states.CombatState;
import org.rscemulation.server.util.Captcha;
...
import org.rscemulation.server.util.StatefulEntityCollection;
...
//						p.informOfBubble(bubble);
	...
	/*
	 * (non-Javadoc)
	 * @see org.rscemulation.server.core.Watcher#watchItemBubble(int, int)
	 */
	@Override
	...
	public void onGeneralPurposeMessageReceived(String[] strings)
	{
		...
		{
			sendMessage("@gre@RSCE Security: @whi@" + message);
		}
	}
