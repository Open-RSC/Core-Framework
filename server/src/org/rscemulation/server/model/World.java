...
import org.rscemulation.server.ClientUpdater;
import org.rscemulation.server.Config;
import org.rscemulation.server.DelayedEventHandler;
...
import org.rscemulation.server.event.NpcAggressionEvent;
...
import org.rscemulation.server.model.auctions.AuctionHouse;
import org.rscemulation.server.net.WorldLoader;
		...
		Instance
{
	...
	public static void startLottery(int price) {
	        ...
	        for (Player informee : World.getPlayers()) {
	                ...
	                informee.sendNotification("@gre@Lottery:@whi@ RSCUnity Lottery is now running!");
	        }               
	}
