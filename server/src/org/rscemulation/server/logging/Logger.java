package org.rscemulation.server.logging;
...
import org.rscemulation.server.logging.model.AutoBanLog;
import org.rscemulation.server.logging.model.ChatLog;
import org.rscemulation.server.logging.model.DeathLog;
import org.rscemulation.server.logging.model.DropLog;
import org.rscemulation.server.logging.model.DuelLog;
...
import org.rscemulation.server.logging.model.Log;
import org.rscemulation.server.logging.model.PickUpLog;
...
import org.rscemulation.server.logging.model.ScriptLog;
import org.rscemulation.server.logging.model.ShopLog;
import org.rscemulation.server.logging.model.TradeLog;
...
public class Logger extends Thread {
	...
	private static void appendDeath(DeathLog log) throws OutOfMemoryError {
		...
		.append(log.getY());
		int counter = 0;		
		for (org.rscemulation.server.model.InvItem item : log.getItemsLost()) {
			deathLog.append("', '")
			.append(item.getID())
			.append("', '")
	...
	private static void appendDuel(DuelLog log) throws OutOfMemoryError {
		...
		int counter = 0;
		for (org.rscemulation.server.model.InvItem item : log.getStakedItems()) {
			duelLog.append("', '")
			.append(item.getID())
			.append("', '")
			.append(item.getAmount());
		...
		counter = 0;
		for (org.rscemulation.server.model.InvItem item : log.getStakedAgainstItems()) {
			duelLog.append("', '")
			.append(item.getID())
			.append("', '")
			.append(item.getAmount());
	...
	private static void appendTradeLog(TradeLog log) throws OutOfMemoryError {
		...
		int counter = 0;
		for(org.rscemulation.server.model.InvItem item : log.getTradedItems()) {
			tradeLog.append("', '")
			.append(item.getID())
			.append("', '")
			.append(item.getAmount());
		...
		counter = 0;
		for (org.rscemulation.server.model.InvItem item : log.getRecievedItems()) {
			tradeLog.append("', '")
			.append(item.getID())
			.append("', '")
			.append(item.getAmount());
