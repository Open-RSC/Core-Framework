...
import org.rscemulation.server.networking.RSCConnectionHandler;
import org.rscemulation.server.networking.WebConnectionHandler;
...
public final class Server
{
	...
	/**
	 * Gracefully exits the RSCEmulation server instance
	 * 
	...
	public static void main(String[] args) throws Exception {
		...
		Class.forName("org.rscemulation.server.ServerBootstrap");
		try
		{
			instance = new Server();
		}
