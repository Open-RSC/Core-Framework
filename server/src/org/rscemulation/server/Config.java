...
public class Config {
	public static String STAFF_TELEPORT_LOCATION_DATABASE = "`rscunity`.`teleport_locations`";
	public static String AUCTIONS_TABLE = "`rscunity`.`rscd_auctions`";
	...
	public static void initConfig(File file) throws IOException {
		SERVER_NAME    = "RSCUnity";
		PREFIX         = "@gre@RSCU:@whi@ "; // Prefix that is sent before every custom (non-RSC) message (such as commands).
