...
public final class Constants {
	...
	public static final class GameServer {
		...
		public static final int DWARVEN_RING_BONUS = 3;
	...
	public static final class Quests {
		...
		public static final HashMap<Integer, int[]> questData = new HashMap<Integer, int[]>() {{
			...
			put(COOKS_ASSISTANT, new int[]{1, SKILLS.COOKING.id(), 1000, 200});
			put(DEMON_SLAYER, new int[]{3, -1, 0, 0});
			put(DORICS_QUEST, new int[]{1, SKILLS.MINING.id(), 700, 300});
			put(THE_RESTLESS_GHOST, new int[]{1, SKILLS.PRAYER.id(), 2000, 250});
			put(GOBLIN_DIPLOMACY, new int[]{5, SKILLS.CRAFTING.id(), 500, 60});
			put(ERNEST_THE_CHICKEN, new int[]{4, -1, 0, 0});
			put(IMP_CATCHER, new int[]{1, SKILLS.MAGIC.id(), 1500, 400});
			put(PIRATES_TREASURE, new int[]{2, -1, 0, 0});
			put(PRINCE_ALI_RESCUE, new int[]{3, -1, 0, 0});
			put(ROMEO_N_JULIET, new int[]{5, -1, 0, 0});
			put(SHEEP_SHEARER, new int[]{1, SKILLS.CRAFTING.id(), 500, 100});
			put(SHIELD_OF_ARRAV, new int[]{1, -1, 0, 0});
			put(THE_KNIGHTS_SWORD, new int[]{1, SKILLS.SMITHING.id(), 1400, 1500});
			put(VAMPIRE_SLAYER, new int[]{3, SKILLS.ATTACK.id(), 1300, 600});
			put(WITCHS_POTION, new int[]{1, SKILLS.MAGIC.id(), 900, 200});
			put(DRAGON_SLAYER, new int[]{2, -1, 2600, 1200}); // Skill ID in Dragon Slayer files
			put(WITCHS_HOUSE, new int[]{4, SKILLS.HITS.id(), 1300, 600});
			put(LOST_CITY, new int[]{3, -1, 0, 0});
			put(HEROS_QUEST, new int[]{1, -1, 300, 200}); // Skill ID Handled in Heros files
			put(DRUIDIC_RITUAL, new int[]{4, SKILLS.HERBLAW.id(), 1000, 0});
			put(MERLINS_CRYSTAL, new int[]{6, -1, 0, 0});
			put(SCORPION_CATCHER, new int[]{1, SKILLS.STRENGTH.id(), 1500, 500});
			put(FAMILY_CREST, new int[]{1, -1, 0, 0});
			put(TRIBAL_TOTEM, new int[]{1, SKILLS.THIEVING.id(), 800, 300});
			put(FISHING_CONTEST, new int[]{1, SKILLS.FISHING.id(), 0, 300}); // Base XP Handled in Fishing Contest files
			put(MONKS_FRIEND, new int[]{1, SKILLS.WOODCUT.id(), 500, 500});
			...
			put(TREE_GNOME_VILLAGE, new int[]{2, SKILLS.ATTACK.id(), 800, 900});
			put(THE_HAZEEL_CULT, new int[]{1, SKILLS.THIEVING.id(), 2000, 200});
			put(SHEEP_HERDER, new int[]{4, -1, 0, 0});
			put(PLAGUE_CITY, new int[]{1, SKILLS.MINING.id(), 700, 300});
			put(SEA_SLUG, new int[]{1, SKILLS.FISHING.id(), 700, 800});
			put(WATERFALL_QUEST, new int[]{1, -1, 1000, 900}); // Skill ID Handled in Waterfall files
			put(BIOHAZARD, new int[]{3, SKILLS.THIEVING.id(), 2000, 200});
			put(JUNGLE_POTION, new int[]{1, SKILLS.HERBLAW.id(), 1600, 500});
			put(GRAND_TREE, new int[]{5, -1, 0, 0}); // XP Handled in Grade Tree files
			put(SHILO_VILLAGE, new int[]{2, SKILLS.CRAFTING.id(), 500, 500});
			...
			put(WATCHTOWER, new int[]{4, SKILLS.MAGIC.id(), 1000, 1000});
			put(DWARF_CANNON, new int[]{1, SKILLS.CRAFTING.id(), 1000, 200});
			put(MURDER_MYSTERY, new int[]{3, SKILLS.CRAFTING.id(), 750, 150});
