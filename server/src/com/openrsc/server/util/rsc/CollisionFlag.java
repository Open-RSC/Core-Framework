...
public class CollisionFlag {
	...
	private static final int SOURCE_EAST = 8;
	private static final int SOURCE_NORTH = 4;
	private static final int SOURCE_SOUTH = 1;
	private static final int SOURCE_WEST = 2;
