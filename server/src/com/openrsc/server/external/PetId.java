...
public enum PetId {
	...
	private static final Map<Integer, PetId> byId = new HashMap<Integer, PetId>();
	static {
		for (PetId npc : PetId.values()) {
	...
	public static PetId getById(Integer id) {
		return byId.getOrDefault(id, PetId.NOBODY);
	}
