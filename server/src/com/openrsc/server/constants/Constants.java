...
public final class Constants {
	...
	public final Item[] OPENPK_STARTER_ITEMS = {new Item(ItemId.IRON_2_HANDED_SWORD.id(), 1), new Item(ItemId.RUBY_AMULET_OF_STRENGTH.id(), 1), new Item(ItemId.LARGE_IRON_HELMET.id(), 1), new Item(ItemId.IRON_PLATE_MAIL_BODY.id(), 1), new Item(ItemId.IRON_CHAIN_MAIL_BODY.id(), 1), new Item(ItemId.IRON_PLATE_MAIL_LEGS.id(), 1), new Item(ItemId.AIR_RUNE.id(), 100, false), new Item(ItemId.MIND_RUNE.id(), 100, false), new Item(ItemId.WATER_RUNE.id(), 100, false), new Item(ItemId.EARTH_RUNE.id(), 100, false), new Item(ItemId.FIRE_RUNE.id(), 100, false), new Item(ItemId.SHORTBOW.id(), 1, false), new Item(ItemId.IRON_ARROWS.id(), 100, false), new Item(ItemId.LOBSTER.id(), 10000, true), new Item(ItemId.SHARK.id(), 10000, true)};
	public final int[] OPENPK_NONSTARTER_UNALCHABLE_ITEMS = {ItemId.SHARK.id(), ItemId.MANTA_RAY.id(), ItemId.RAW_SHARK.id(), ItemId.RAW_MANTA_RAY.id()};
