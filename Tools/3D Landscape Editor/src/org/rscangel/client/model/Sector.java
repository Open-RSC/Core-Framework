...
public class Sector
{
	 ...
	 */
	// -------------------------------------------------------------------------------------------------------------------
	public static Sector unpack( ByteBuffer in, String origin )
			throws IOException
	{
		...
		Sector sector = new Sector( origin );
		for( int i = 0; i < length; i++ )
		{
			Tile newTile = Tile.unpack( in );
			// newTile.groundElevation = (byte)i; for testing

			if( newTile != null )
				sector.setTile( i, newTile );
		}
