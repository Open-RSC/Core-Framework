...
public class Sprite {
	 ...
	 */
	static Sprite deserializeFrom(File file) throws IOException, ClassNotFoundException {
	 ...
	 */
	static Sprite fromImage(BufferedImage img) {
	 ...
	 */
	static Sprite unpack(ByteBuffer in) throws IOException {
		if (in.remaining() < 25)
	 ...
	 */
	void setSomething(int width2, int height2) {
		this.width2 = width2;
	 ...
	 */
	void setName(int id, String packageName) {
		this.id = id;
	 ...
	 */
	void serializeTo(File file) throws IOException {
	...
	ByteBuffer pack() throws IOException {
		...
		for (int pixel1 : pixels) out.putInt(pixel1);
