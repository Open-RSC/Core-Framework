...
public class SpriteEditor extends JFrame implements ActionListener 
{
	...
	public void actionPerformed(ActionEvent event) 
	{
		...
		if(event.getSource() == buttons.get("Unpack")) 
		{
			try
			{
		...
		if(event.getSource() == buttons.get("Load Image")) 
		{
			JFileChooser chooser = new JFileChooser(System.getProperty("user.dir"));
		...
		if(event.getSource() == buttons.get("Save Image")) 
		{
			JFileChooser chooser = new JFileChooser(System.getProperty("user.dir"));
			chooser.setFileFilter(new FileNameExtensionFilter("Image Files", "png"));
			if(chooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION) 
		...
		if(event.getSource() == buttons.get("Refresh")) 
		{
			if(currentSprite != null) 
			{
