package spriteeditor.data;

/**
 * Handles data file decryption.
 * Truth is I'm not sure what a lot of this mumbo jumbo is.
 */
public class DataFileDecrypter {
	/**
	 * Unpacks the given data
	 */
	public static void unpackData(byte[] abyte0, int i, byte[] abyte1, int j, int k) {
	...
	/**
	 * Seems to set DataFileVariables' info
	 */
	...
	private static void method131(DataFileVariables dataFileVariables) {
		...
		while (flag19) {
			...
			dataFileVariables.aBoolean477 = byte0 != 0;
			...
			for (int j = 0; j < 16; j++) {
				...
				dataFileVariables.aBooleanArray492[j] = byte1 == 1;
			}
			...
			int l5 = 0x186a0 * dataFileVariables.anInt480;
			int i5 = -1;
			int j5 = 0;
			...
			flag19 = dataFileVariables.anInt486 == dataFileVariables.anInt503 + 1 && dataFileVariables.anInt476 == 0;
		}
	}
