...
{
	// -------------------------------------------------------------------------------------------------------------------
	public Camera( GameImage gameImage, int maxModels, int maxCameraModels,
			int k )
	{
		anInt374 = 50;
		...
		for( int i1 = 0; i1 < 256; i1++ )
		{
			...
			anIntArray385[i1 + 256] = (int) (Math
					.cos( (double) i1 * 0.02454369D ) * 32768D);
		}

		for( int j1 = 0; j1 < 1024; j1++ )
		{
			anIntArray384[j1] = (int) (Math.sin( (double) j1 * 0.00613592315D ) * 32768D);
			anIntArray384[j1 + 1024] = (int) (Math
					.cos( (double) j1 * 0.00613592315D ) * 32768D);
		}
	}
	...
	public void finishCamera()
	{
		...
		for( int i = 0; i < modelCount; i++ )
		{
			...
			modelArray[i].method201( anInt403, anInt404, anInt405, anInt406,
					anInt407, anInt408, cameraSizeInt, anInt379 );
		}

		if( modelArray[modelCount] != null )
		{
			modelArray[modelCount].method201( anInt403, anInt404, anInt405,
					anInt406, anInt407, anInt408, cameraSizeInt, anInt379 );
		}
		...
		for( int i4 = 0; i4 < cameraModelCount; i4++ )
		{
			...
			if( model_2 == aModel_423 )
			{
				...
				gameImage.method245( l11 + halfWidth2, j12, i10, k10,
						anIntArray416[l], j11, (256 << cameraSizeInt) / j9 );
						...
						&& currentVisibleModelCount < maxVisibleModelCount )
				{
					...
					if( mouseY >= j12 && mouseY <= j12 + k10 && mouseX >= l11
							&& mouseX <= l11 + i10 && !model_2.aBoolean263
			...
			else
			{
				...
				for( int k11 = 0; k11 < l10; k11++ )
				{
					...
					if( model_2.anIntArray241[l] == 0xbc614e )
					{
						if( cameraModel.anInt365 < 0 )
						{
							j10 = (model_2.anInt308 - model_2.anIntArray232[k2])
									+ model_2.aByteArray233[k2];
						}
						else
						{
							j10 = model_2.anInt308 + model_2.anIntArray232[k2]
					...
					if( model_2.anIntArray229[k2] >= anInt379 )
					{
						...
						{
							anIntArray443[k8] += (model_2.anIntArray229[k2] - zoom4)
									/ zoom3;
						}
					...
					else
					{
						...
						{
							int k7 = model_2.anIntArray229[k2]
									- model_2.anIntArray229[k9];
							int i5 = model_2.anIntArray227[k2]
									- ((model_2.anIntArray227[k2] - model_2.anIntArray227[k9]) * (model_2.anIntArray229[k2] - anInt379))
									/ k7;
							int j6 = model_2.anIntArray228[k2]
									- ((model_2.anIntArray228[k2] - model_2.anIntArray228[k9]) * (model_2.anIntArray229[k2] - anInt379))
									/ k7;
							anIntArray441[k8] = (i5 << cameraSizeInt)
									/ anInt379;
							anIntArray442[k8] = (j6 << cameraSizeInt)
									/ anInt379;
							anIntArray443[k8] = j10;
							k8++;
						}
						...
						if( model_2.anIntArray229[k9] >= anInt379 )
						{
							int l7 = model_2.anIntArray229[k2]
									- model_2.anIntArray229[k9];
							...
							int k6 = model_2.anIntArray228[k2]
									- ((model_2.anIntArray228[k2] - model_2.anIntArray228[k9]) * (model_2.anIntArray229[k2] - anInt379))
									/ l7;
							anIntArray441[k8] = (j5 << cameraSizeInt)
									/ anInt379;
							anIntArray442[k8] = (k6 << cameraSizeInt)
									/ anInt379;
							anIntArray443[k8] = j10;
							k8++;
						}
	...
	private void method281( int i, int j, int k, int l, int i1, int ai[],
			int ai1[], int ai2[], Model model, int j1 )
	{
		if( i1 == 3 )
		{
	...
	private void method282( int i, int j, int k, int ai[], int ai1[],
			int ai2[], int l, Model model )
	{
		if( l == -2 )
			return;
		if( l >= 0 )
		...
		if( model.isGiantCrystal )
		{
			for( i = modelLeftY; i < modelRightY; i += byte0 )
			{
				...
				else
				{
					...
					method290( anIntArray437, -k6, l2 + j, 0, anIntArray377,
							l7, i9 );
					l2 += i2;
				}
			}
		...
		if( aBoolean386 )
		{
			for( i = modelLeftY; i < modelRightY; i += byte0 )
			{
				...
				else
				{
					...
					method289( anIntArray437, -l6, l2 + j, 0, anIntArray377,
							i8, j9 );
					l2 += i2;
				}
			}
	...
	private void method293( int i )
	{
		...
		if( l == -1 )
		{
			...
			model.anIntArray239[j] = (int) ((double) anInt402 * Math.sqrt( k3
					* k3 + l3 * l3 + i4 * i4 ));
		}
		else
		{
	...
	private boolean method295( CameraModel cameraModel,
			CameraModel cameraModel_1 )
	{
		if( cameraModel.anInt353 >= cameraModel_1.anInt355 )
			return true;
		...
		{
			int i1 = ai[k4];
			int i2 = (k2 - model.anIntArray227[i1]) * j3
					+ (l2 - model.anIntArray228[i1]) * k3
					+ (i3 - model.anIntArray229[i1]) * l3;
		...
		{
			int j1 = ai1[l4];
			int j2 = (k2 - model_1.anIntArray227[j1]) * j3
					+ (l2 - model_1.anIntArray228[j1]) * k3
					+ (i3 - model_1.anIntArray229[j1]) * l3;
	...
	private boolean method296( CameraModel cameraModel,
			CameraModel cameraModel_1 )
	{
		Model model = cameraModel.aModel_359;
		Model model_1 = cameraModel_1.aModel_359;
		...
		{
			int i1 = ai[i4];
			int k1 = (i2 - model.anIntArray227[i1]) * l2
					+ (j2 - model.anIntArray228[i1]) * i3
					+ (k2 - model.anIntArray229[i1]) * j3;
		...
		{
			int j1 = ai1[j4];
			int l1 = (i2 - model_1.anIntArray227[j1]) * l2
					+ (j2 - model_1.anIntArray228[j1]) * i3
					+ (k2 - model_1.anIntArray229[j1]) * j3;
	...
	public boolean method309( int ai[], int ai1[], int ai2[], int ai3[] )
	{
		...
		else
		{
			...
			int i11 = method306( ai2[(i1 + 1) % j], ai3[(i1 + 1) % j], ai2[i1],
					ai3[i1], ai1[k] );
			int l15 = method306( ai2[((j1 - 1) + j) % j], ai3[((j1 - 1) + j)
		...
		while( byte0 == 0 )
			if( ai1[k] < ai1[l] )
			{
				if( ai1[k] < ai3[i1] )
				{
					if( ai1[k] < ai3[j1] )
					{
						...
						int j11 = method306( ai2[(i1 + 1) % j], ai3[(i1 + 1)
								% j], ai2[i1], ai3[i1], ai1[k] );
					...
					else
					{
						...
						int k11 = method306( ai2[(i1 + 1) % j], ai3[(i1 + 1)
								% j], ai2[i1], ai3[i1], ai3[j1] );
						int j16 = ai2[j1];
			...
			else if( ai3[i1] < ai3[j1] )
			{
				int k3 = method306( ai[(k + 1) % i], ai1[(k + 1) % i], ai[k],
						ai1[k], ai3[i1] );
				int j8 = method306( ai[((l - 1) + i) % i], ai1[((l - 1) + i)
						% i], ai[l], ai1[l], ai3[i1] );
				int l12 = ai2[i1];
				int k17 = method306( ai2[((j1 - 1) + j) % j],
						ai3[((j1 - 1) + j) % j], ai2[j1], ai3[j1], ai3[i1] );
			...
			else
			{
				int l3 = method306( ai[(k + 1) % i], ai1[(k + 1) % i], ai[k],
						ai1[k], ai3[j1] );
				int k8 = method306( ai[((l - 1) + i) % i], ai1[((l - 1) + i)
						% i], ai[l], ai1[l], ai3[j1] );
		...
		while( byte0 == 1 )
			if( ai1[k] < ai3[i1] )
			{
				...
				int j4 = method306( ai[(k + 1) % i], ai1[(k + 1) % i], ai[k],
						ai1[k], ai3[j1] );
				int l8 = method306( ai[((l - 1) + i) % i], ai1[((l - 1) + i)
						% i], ai[l], ai1[l], ai3[j1] );
			...
			else if( ai3[i1] < ai3[j1] )
			{
				int k4 = method306( ai[(k + 1) % i], ai1[(k + 1) % i], ai[k],
						ai1[k], ai3[i1] );
				int i9 = method306( ai[((l - 1) + i) % i], ai1[((l - 1) + i)
						% i], ai[l], ai1[l], ai3[i1] );
				int l13 = ai2[i1];
				int k18 = method306( ai2[((j1 - 1) + j) % j],
						ai3[((j1 - 1) + j) % j], ai2[j1], ai3[j1], ai3[i1] );
			...
			else
			{
				int l4 = method306( ai[(k + 1) % i], ai1[(k + 1) % i], ai[k],
						ai1[k], ai3[j1] );
				int j9 = method306( ai[((l - 1) + i) % i], ai1[((l - 1) + i)
						% i], ai[l], ai1[l], ai3[j1] );
		...
		while( byte0 == 2 )
			if( ai3[i1] < ai1[k] )
			{
				...
				int k14 = method306( ai2[(i1 + 1) % j], ai3[(i1 + 1) % j],
						ai2[i1], ai3[i1], ai1[l] );
				int i19 = method306( ai2[((j1 - 1) + j) % j],
						ai3[((j1 - 1) + j) % j], ai2[j1], ai3[j1], ai1[l] );
			...
			else if( ai1[k] < ai1[l] )
			{
				...
				int l14 = method306( ai2[(i1 + 1) % j], ai3[(i1 + 1) % j],
						ai2[i1], ai3[i1], ai1[k] );
				int j19 = method306( ai2[((j1 - 1) + j) % j],
						ai3[((j1 - 1) + j) % j], ai2[j1], ai3[j1], ai1[k] );
			...
			else
			{
				...
				int i15 = method306( ai2[(i1 + 1) % j], ai3[(i1 + 1) % j],
						ai2[i1], ai3[i1], ai1[l] );
				int k19 = method306( ai2[((j1 - 1) + j) % j],
						ai3[((j1 - 1) + j) % j], ai2[j1], ai3[j1], ai1[l] );
		...
		if( ai1[k] < ai3[i1] )
		{
			...
			int j15 = method306( ai2[(i1 + 1) % j], ai3[(i1 + 1) % j], ai2[i1],
					ai3[i1], ai1[k] );
			int l19 = method306( ai2[((j1 - 1) + j) % j], ai3[((j1 - 1) + j)
					% j], ai2[j1], ai3[j1], ai1[k] );
