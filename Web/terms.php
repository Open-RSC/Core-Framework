	...
	<div class="misc-module">
		<section class="terms-body">
			...
			<div class="item-section terms">
				...
				If you have elected to purchase any Game, product, service (including any subscription service) and/or Virtual Items through Open RSC’s commerce systems, upon your acceptance of these terms and submission of your order, you hereby agree that we have the right to automatically charge your credit card/paypal or debit your account for the applicable fees or charges, plus any applicable taxes we are required to collect, and you authorize us to do so. You agree to pay all fees incurred by you or anyone using an Account registered to you. You agree to notify Open RSC promptly of any changes to your credit or debit card account number, its expiration date and/or your billing address, and you agree to notify Open RSC promptly if your credit card expires or is canceled for any reason. After the submission of your order, you will receive an e-mail receipt from Open RSC providing details of your purchase. Please print a copy of such e-mail for your records.
				</p>
				<p>
				...
				Open RSC may revise the pricing for the goods and services offered, including without limitation subscription plans and/or Virtual Items for any Game, at any time.
				</p>
				<p>
				<span class="num">2.4</span>
				All charges made to your credit card or debits to your account can be viewed by you under the Transaction History section of Open RSC’s Account Management site.
				</p>
				<p>
			...
			<div class="item-section terms">
				...
				Open RSC MAY SUSPEND, MODIFY, TERMINATE OR DELETE ANY ACCOUNT AT ANY TIME FOR ANY REASON OR FOR NO REASON, WITH OR WITHOUT NOTICE TO YOU. Accounts terminated by Open RSC for any type of abuse, including without limitation a violation of these Terms of Use will not be reactivated for any reason. For purposes of explanation and not limitation, most account suspensions, terminations and/or deletions are the result of violations of this Terms of Use.
				</p>
			</div>
			<div class="item-header">
                <h1>Open RSC - CHAT RULES</h1>
            </div>
			<div class="item-section">
			<p>
				<strong>
				Communicating on the Site, in a Game or through the Service with other users and Open RSC representatives, whether by text, voice or any other method, (collectively, “Chat”) is an integral part of the Game and the Service.
				</strong>
			</p>
			<p>
				<strong>
				You understand that, by using the Chat features, you may be exposed to communications (including in written, verbal, electronic, digital, machine-readable or other form) that you might find objectionable. You understand that any content sent or appearing through a Chat feature is the sole responsibility of the individual(s) transmitting such content. This means that you, and not Open RSC, are entirely responsible for all content that you transmit. Under no circumstances will Open RSC or its third party providers be liable for any errors or omissions in any content or for any loss or damages of any kind incurred as a result of the access to, downloading, viewing, listening, use of or inability to use any content, including User Content.
				</strong>
			</p>
			<p>
				<strong>
			...
			<div class="item-section terms">
				...
				Transmit or post any content or language which, in the sole and absolute discretion of Open RSC, is deemed to be offensive, including without limitation content or language that is unlawful, harmful, threatening, abusive, harassing, defamatory, vulgar, obscene, hateful, sexually explicit, or racially, ethnically or otherwise objectionable, nor may you use a misspelling or an alternative spelling to circumvent the content and language restrictions listed above;
				</p>
				<p>
				...
				Participate in any action that, in the sole and absolute opinion of Open RSC, results or may result in an authorized user of the Game or the Site being “scammed” or defrauded out of gold, weapons, armor, or any other items that user has earned through authorized game play in the Game (including but not limited to participation in player-run casinos);
				</p>
				<p>
				<span class="num">8)</span>
				Impersonate any real person, including without limitation any “staff members” or any other Open RSC employee, nor may you communicate in the Game, or on the Site or Service in any way designed to make others believe that your message constitutes a Server message or was otherwise posted by any Open RSC employee.
				</p>
			</div>
			<div class="item-header">
                <h1>Open RSC - FORUM RULES</h1>
            </div>
			<div class="item-section terms">
				<p>
				<span class="num">1)</span>
			...
			<div class="item-section terms">
				...
				Do not buy/sell Open RSC gold, items or accounts for real cash.
				<br /><br />
				...
				The involvement of any currency, items, or services external to Open RSC Server (Including but not limited to: real money (USD, Euro, Etc), regulated or otherwise (Bitcoins), Food/Delivery, Virtual currency of any other game, Beta Keys for the latest new game, etc... for any of that Open RSC server's virtual items or service (Including by not limited to: Items, Powerleveling, Accounts/Characters sales) is strictly forbidden.
				<br /><br />
				The economy of Open RSC is tracked very closely by the Game Masters and Management, and we take this type of behavior very seriously. Violation of this rule will often result in permanent bans for all accounts involved (Buyers, Sellers, Mules/Transferers).
				<br /><br />
				...
				Do not pretend to be any member of the Open RSC staff.
				<br /><br />
				...
				Do not pick names that are defamatory, vulgar, prejudice/racist, or explicitly sexual. Poorly chosen names result in a permanent ban. Please take the time to think up a non-offensive name before creating an account. Open RSC staff members reserve the right to change a character name for any reason.
				</p>
			</div>
			<div class="item-section terms">
            	<h2>Thank you</h2>
                <p>
				On behalf of Open RSC, thank you for reading and applying to these rules to make Open RSC a better place and also keeping your account safe! Please remember that you are a guest and act with the same courtesy and respect you expect from other guests. 
				</p>
            </div>
		</section>
	</div>
