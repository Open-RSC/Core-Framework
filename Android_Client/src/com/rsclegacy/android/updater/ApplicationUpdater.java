...
public class ApplicationUpdater extends Activity {
	...
	public static final String ANDROID_CACHE_URL = "http://www.openrsc.com/android/";
	...
	class DownloadApplication extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... aurl) {
			...
			try {
				connection = (HttpURLConnection) new URL(ANDROID_CACHE_URL + "openrsc.apk").openConnection();
				connection.connect();
