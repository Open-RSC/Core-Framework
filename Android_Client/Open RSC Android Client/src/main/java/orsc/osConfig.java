...
public class osConfig {
	...
	public static final String DL_URL = "10.0.2.2"; // needs to be set as public for the Android client to use
	public static final String ANDROID_DOWNLOAD_PATH = "http://" + DL_URL + "/downloads/";
	public static final String CACHE_URL = "http://" + DL_URL + "/downloads/";
	public static final String MD5_TABLENAME = "MD5.SUM";
	public static final int ANDROID_CLIENT_VERSION = 78; // Important! Depends on web server android_version.txt to check for an updated version
