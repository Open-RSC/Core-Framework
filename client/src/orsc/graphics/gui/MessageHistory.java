...
public class MessageHistory {
	...
	public static String[] messageHistoryClan = new String[100];
	public static String[] messageHistoryMessage = new String[100];
	public static String[] messageHistoryColor = new String[100];
}
