package org.rscemulation.loader;
...
import org.rscemulation.client.Config;
import org.rscemulation.client.ImplementationDelegate;
import org.rscemulation.client.RSCEmulation;
import org.rscemulation.client.mudclient;
import org.rscemulation.loader.util.unzip;
		...
		Runnable
{
	...
	private final static String cacheDir = System.getProperty("user.home") + FILE_SEPARATOR + ".rscunity";
	
	private final static File JAR = new File(cacheDir + FILE_SEPARATOR + "rscunity.zip");
	...
	private RSCEmulation<AppletLoader> instance;
	...
	// Entry point for the RSCEmulation web applet
	public void init() {
	...
	private void download() {
		File file = new File(cacheDir + File.separator + "rscunity.zip");
		if (file.exists()) {
			file.delete();
		}
	...
	/*************************************************************/
	/** Forward events from the applet to the RSCEmulation game  */
	/**                                                          */
