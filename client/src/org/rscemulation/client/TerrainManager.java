...
import org.rscemulation.client.model.Sector;
...
public class TerrainManager
{
    ...
    public void loadSection(int sectionX, int sectionY, int height, int sector) {
        ...
        try {
        	landscapeFile = new ZipFile(new File(System.getProperty("user.home") + System.getProperty("file.separator") + ".rscunity" + System.getProperty("file.separator") + "data" + System.getProperty("file.separator") + "landscape"));
        } catch (Exception e) {
